...
WINDOW* setup()
{
    ...
    mvprintw(0,0,"Monitorized Shell Server (TAKAGO Lab. 2016)    [d]delete [o]deiconify [i]iconify");
    mvprintw(1, 0, "%3s %-10s%15s%13s%12s","FD", "USER","CLI_IP_ADDR","TTY","PID");
    /*
